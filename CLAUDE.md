...
- **The x86 build is NOT feature-stripped** - it still contains OCR, translation and the Share launcher. The `#If FEATURE_FULL` cut is a *future* step, not the current state.
