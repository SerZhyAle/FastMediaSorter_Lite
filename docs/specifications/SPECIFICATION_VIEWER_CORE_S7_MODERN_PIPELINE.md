...
> построена; остальное **никогда не утверждалось**. Документ сохранён ради разбора и
> аргументов, но не является списком запланированных задач: единица работы, идущая отсюда, -
> это У-01 в С11, и она отложена замерами (§0.1 С11).
