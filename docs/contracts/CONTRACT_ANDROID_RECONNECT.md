...
> Version: 1.0 (2026-07-15). Pairs with [SPECIFICATION_QR_IMPORT_ANDROID.md](../specifications/done/SPECIFICATION_QR_IMPORT_ANDROID.md) (frozen wire contract) and [SPECIFICATION_SHARE_SECURITY_HARDENING.md](../specifications/done/SPECIFICATION_SHARE_SECURITY_HARDENING.md) §3.4 (server side).
