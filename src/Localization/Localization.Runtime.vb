...
Partial Public NotInheritable Class Localization
    ...
    Private Shared Sub AddRuntimeStrings()
        ...
        Add("Не удалось открыть страницу загрузки." & vbCrLf & "{0}",
            "Could not open the download page." & vbCrLf & "{0}",
            "Не вдалося відкрити сторінку завантаження." & vbCrLf & "{0}",
            "Die Download-Seite konnte nicht geöffnet werden." & vbCrLf & "{0}",
            "Impossibile aprire la pagina di download." & vbCrLf & "{0}",
            "No se pudo abrir la página de descarga." & vbCrLf & "{0}",
            "Impossible d'ouvrir la page de téléchargement." & vbCrLf & "{0}",
            "Não foi possível abrir a página de download." & vbCrLf & "{0}",
            "تعذّر فتح صفحة التنزيل." & vbCrLf & "{0}",
            "डाउनलोड पेज नहीं खुल सका।" & vbCrLf & "{0}",
            "ডাউনলোড পেজ খোলা যায়নি।" & vbCrLf & "{0}",
            "ڈاؤن لوڈ صفحہ نہیں کھل سکا۔" & vbCrLf & "{0}",
            "无法打开下载页面。" & vbCrLf & "{0}")
